  ...
  <div class="bg-white rounded-xl shadow-md relative">
    <div class="p-4">
      ...
      <div class="mb-5">
        ...
        <button class="text-green-500 hover:text-green-700 mb-5"
      ...
      <div class="flex flex-col lg:flex-row justify-between mb-4">
        <div class="text-orange-700 mb-3">
          <i class="pi pi-map-marker text-orange-500"></i> {{ job.location }}
        </div>
        <RouterLink :to="'/jobs/' + job.id"
          class="h-[36px] bg-black hover:bg-orange-700 text-white px-4 py-2 rounded-lg text-center text-sm">
          Read More
        </RouterLink>
      </div>
